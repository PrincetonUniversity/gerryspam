...
elec_fp = '/Users/hopecj/Downloads/precinct_2018.csv'
#load into dataframe
...
prec_elec_rn = prec_elec.rename(columns = {
        ...
        'votes libertarian US Senate' : 'G18LSEN',
...
prec_elec_keep = prec_elec_rn[['G18DHOR', 'G18LHOR', 'G18RHOR', 'G18DSEN', 'G18LSEN', 'G18RSEN']]
prec_elec_keep["year"] = 2018

#prec_elec_rn['G18OGOV'] = prec_elec_rn['G18OGOV1'].astype(int) + prec_elec_rn['G18OGOV2'].astype(int)+ prec_elec_rn['G18OGOV3'].astype(int)

#this is ready to be matched to precinct names now

prec_elec_keep.to_csv('/Users/hopecj/projects/gerryspam/NJ/dat/NJ_G18_MIT.csv')