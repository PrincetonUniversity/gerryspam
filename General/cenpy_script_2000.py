...
conn = c.base.Connection('DECENNIALSF12000')
...
#save file  
data.to_csv('/Volumes/GoogleDrive/Shared drives/princeton_gerrymandering_project/States and local partners/Oregon/Data/Demographics/California/CA2010pop_breakdown.csv')
