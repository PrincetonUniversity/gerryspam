...
# function to clean
def ar_prec_transform(
    dat,
    county,
    custom_transformation=None,
    upper=True,
    chop_five_digs=False,
    chop_three_digs=False,
    chop_six_digs=False,
    dash_to_slash=False,
    jefferson_transform=False,
    marion_transform=False,
    perry_transform=False,
    pope_transform=False,
    pulaski_transform=False,
    saline_transform=False,
    sebastian_transform=True,
):
    ...
    if chop_three_digs:
       ...
       if perry_transform:
        dat_out["prec_new"] = (
            dat_out["prec_new"].str.slice(start=1, stop=2) + "-" + dat_out["prec_new"].str.slice(start=5)
...
## TEST FOR ARKANSAS COUNTY
ar = shp_df.loc[shp_df["county_nam"] == "Arkansas"]
ar["prec_new"] = ar["precinct"].copy()
ar["prec_new"] = ar["prec_new"].str.slice(start=5)
##

# ashley cnty
c2 = ar_prec_transform(
    shp_df,
    "Ashley",
    {
...
# bradley cnty
c6 = ar_prec_transform(
    shp_df,
    "Bradley",
    {"Warren Ward 1": "Ward 1", "Warren Ward 2": "Ward 2", "Warren Ward 3": "Ward 3"},
    upper=False,
    chop_five_digs=True,
)
...
c9 = ar_prec_transform(
    shp_df, "Chicot", {"Carlton": "Carlton 1"}, upper=False, chop_five_digs=True
)

# clark cnty
c10 = ar_prec_transform(
    shp_df,
    "Clark",
    {
        "Central 1": "Central",
...
# columbia county
c14 = ar_prec_transform(
    shp_df, "Columbia", {"Taylor City": "Taylor", "Waldo City": "Waldo"}
)

# conway county
c15 = ar_prec_transform(
    shp_df, "Conway", {"St Vincent": "St. Vincent", "Lick Mountain": "Lick Mtn."}
)

# craighead
# took the "precinct" out of elections data
c16 = ar_prec_transform(shp_df, "Craighead", upper=False)

# crawford
c17 = ar_prec_transform(
    shp_df,
    "Crawford",
    {
        "Alma 01": "Alma 1",
...
c23 = ar_prec_transform(
    shp_df,
    "Fulton",
    {"MS - Afton": "MAMMOTH SPRING/AFTON", "Fulton - Mt. Calm": "FULTON/MT CALM"},
    dash_to_slash=True,
)
...
# hot spring county
c28 = ar_prec_transform(
    shp_df, "Hot Spring", {"Friendship City": "Friendship"}, upper=False
)
...
c46 = ar_prec_transform(shp_df, "Monroe", chop_five_digs=True)

# montgomery
c47 = ar_prec_transform(
    shp_df,
    "Montgomery",
    {
...
# newton
c49 = ar_prec_transform(shp_df, "Newton", {"Mt Sherman": "Mt. Sherman"}, upper=False)
...
# scott
c60 = ar_prec_transform(
    shp_df,
    "Scott",
    {"Lewis 1": "Lewis Ward 1", "Lewis 2": "Lewis Ward 2", "Lewis 3": "Lewis Ward 3"},
    chop_five_digs=True,
)
...
# stone
c66 = ar_prec_transform(
    shp_df, "Stone", {"Angora Mtn": "Angora Mountain", "Dodd Mtn": "Dodd Mountain"}
)
...
merged.to_file(
    "/Volumes/GoogleDrive/Shared drives/princeton_gerrymandering_project/OpenPrecincts/States for site/Alaska/Final/AK_Prec_G14_16_18.shp"
)
