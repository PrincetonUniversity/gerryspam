...
geo_path = "/Volumes/GoogleDrive/Shared drives/princeton_gerrymandering_project/geocoding/Geocoded States from Civis Voterroll/geocoded_AR.csv"
...
df = pd.DataFrame(df)
df.to_csv('/Volumes/GoogleDrive/Shared drives/princeton_gerrymandering_project/OpenPrecincts/States for site/Arkansas/VR Precincts/AR_Civis_VR.csv')
